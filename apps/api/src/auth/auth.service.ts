...
export class AuthService {
  ...
  async refresh(raw:string) {
    let payload:any; try { payload=this.jwt.verify(raw,{secret:this.config.getOrThrow("JWT_REFRESH_SECRET")}); } catch { throw new UnauthorizedException("Invalid refresh token"); }
