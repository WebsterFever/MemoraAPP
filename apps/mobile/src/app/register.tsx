...
export default function Register() {
 ...
 {!!error&&<Text style={s.error}>{error}</Text>}<Pressable style={s.button} onPress={submit} disabled={loading}>{loading?<ActivityIndicator color="#fff"/>:<Text style={s.buttonText}>Create account</Text>}</Pressable><Text style={s.footer}>Already have an account? <Link href={"/login" as any} style={s.link}>Sign in</Link></Text></View></SafeAreaView>;
}
